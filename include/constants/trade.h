...
#define INGAME_TRADE_GEODUDE 4
#define INGAME_TRADE_SANDSHREW 5
#define INGAME_TRADE_VULPIX 6
#define INGAME_TRADE_GRIMER 7
#define INGAME_TRADE_DARUMAKA 8
#define INGAME_TRADE_PONYTA 9
#define INGAME_TRADE_WEEZING 10
#define INGAME_TRADE_RAICHU 11
