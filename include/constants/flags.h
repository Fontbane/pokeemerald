...
#define FLAG_HIDDEN_ITEM_MT_PYRE_EXTERIOR_ULTRA_BALL         (FLAG_HIDDEN_ITEMS_START + 0x6D)
...
#define FLAG_HIDDEN_ITEM_SS_TIDAL_LOWER_DECK_LEFTOVERS       (FLAG_HIDDEN_ITEMS_START + 0x70)
...
#define FLAG_HIDDEN_ITEM_ROUTE_111_NORMAL_GEM                (FLAG_HIDDEN_ITEMS_START + 0x71)
#define FLAG_HIDDEN_ITEM_ROUTE_111_HEART_SCALE               (FLAG_HIDDEN_ITEMS_START + 0x72)
#define FLAG_HIDDEN_ITEM_ROUTE_111_WATER_GEM                 (FLAG_HIDDEN_ITEMS_START + 0x73)
#define FLAG_HIDDEN_ITEM_ROUTE_111_GROUND_GEM                (FLAG_HIDDEN_ITEMS_START + 0x74)
#define FLAG_HIDDEN_ITEM_ROUTE_114_POISON_GEM                (FLAG_HIDDEN_ITEMS_START + 0x75)
#define FLAG_HIDDEN_ITEM_ROUTE_115_FAIRY_GEM                 (FLAG_HIDDEN_ITEMS_START + 0x76)
#define FLAG_HIDDEN_ITEM_ROUTE_116_ROCK_GEM                  (FLAG_HIDDEN_ITEMS_START + 0x77)
#define FLAG_HIDDEN_ITEM_ROUTE_119_FLYING_GEM                (FLAG_HIDDEN_ITEMS_START + 0x78)
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_2F_HEART_SCALE         (FLAG_HIDDEN_ITEMS_START + 0x79)
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_2F_HARD_STONE          (FLAG_HIDDEN_ITEMS_START + 0x7A)
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_2F_FIGHTING_GEM        (FLAG_HIDDEN_ITEMS_START + 0x7B)
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_2F_DARK_GEM            (FLAG_HIDDEN_ITEMS_START + 0x7C)
#define FLAG_HIDDEN_ITEM_JAGGED_PASS_ROCK_GEM                (FLAG_HIDDEN_ITEMS_START + 0x7D)
#define FLAG_HIDDEN_ITEM_FIERY_PATH_FIRE_GEM                 (FLAG_HIDDEN_ITEMS_START + 0x7E)
#define FLAG_HIDDEN_ITEM_RUSTURF_TUNNEL_GRASS_GEM            (FLAG_HIDDEN_ITEMS_START + 0x7F)
#define FLAG_HIDDEN_ITEM_METEOR_FALLS_PSYCHIC_GEM            (FLAG_HIDDEN_ITEMS_START + 0x80)
#define FLAG_HIDDEN_ITEM_METEOR_FALLS_DRAGON_GEM             (FLAG_HIDDEN_ITEMS_START + 0x81)
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_HEART_SCALE            (FLAG_HIDDEN_ITEMS_START + 0x82)
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_NORMAL_GEM             (FLAG_HIDDEN_ITEMS_START + 0x83)
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_DUSK_STONE             (FLAG_HIDDEN_ITEMS_START + 0x84)
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_SHINY_STONE            (FLAG_HIDDEN_ITEMS_START + 0x85)
#define FLAG_HIDDEN_ITEM_MT_PYRE_GHOST_GEM                   (FLAG_HIDDEN_ITEMS_START + 0x86)
#define FLAG_HIDDEN_ITEM_SHOAL_CAVE_ICE_GEM                  (FLAG_HIDDEN_ITEMS_START + 0x87)
#define FLAG_HIDDEN_ITEM_NEW_MAUVILLE_ELECTRIC_GEM           (FLAG_HIDDEN_ITEMS_START + 0x88)
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_BUG_GEM             (FLAG_HIDDEN_ITEMS_START + 0x89)
...
#define HIDDEN_ITEM_FLAGS_END FLAG_HIDDEN_ITEM_MOSSDEEP_CITY_NORMAL_GEM //Exclude the items we don't want to regenerate
...
#define FLAG_HIDDEN_ITEM_ABANDONED_SHIP_RM_4_KEY             (HIDDEN_ITEM_FLAGS_END+3)//Doesn't regen
#define FLAG_HIDDEN_ITEM_ABANDONED_SHIP_RM_6_KEY             (HIDDEN_ITEM_FLAGS_END+4)//Doesn't regen
#define FLAG_HIDDEN_ITEM_ABANDONED_SHIP_TM67                 (HIDDEN_ITEM_FLAGS_END+5)//Doesn't regen
#define FLAG_HIDDEN_ITEM_ROUTE_113_TM_32                     (HIDDEN_ITEM_FLAGS_END+6)//Doesn't regen
#define FLAG_HIDDEN_ITEM_NAVEL_ROCK_TOP_SACRED_ASH           (HIDDEN_ITEM_FLAGS_END+7)//Doesn't regen
