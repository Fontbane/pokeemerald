...
#define FLAG_HIDDEN_ITEM_ABANDONED_SHIP_RM_1_KEY             (FLAG_HIDDEN_ITEMS_START + 0x81)//Doesn't regen
#define FLAG_HIDDEN_ITEM_ABANDONED_SHIP_RM_2_KEY             (FLAG_HIDDEN_ITEMS_START + 0x82)//Doesn't regen
#define FLAG_HIDDEN_ITEM_ABANDONED_SHIP_RM_4_KEY             (FLAG_HIDDEN_ITEMS_START + 0x83)//Doesn't regen
#define FLAG_HIDDEN_ITEM_ABANDONED_SHIP_RM_6_KEY             (FLAG_HIDDEN_ITEMS_START + 0x84)//Doesn't regen
#define FLAG_HIDDEN_ITEM_ABANDONED_SHIP_TM67                 (FLAG_HIDDEN_ITEMS_START + 0x85)//Doesn't regen
...
#define FLAG_HIDDEN_ITEM_NAVEL_ROCK_TOP_SACRED_ASH           (FLAG_HIDDEN_ITEMS_START + 0x87)//Doesn't regen
...
#define FLAG_HIDDEN_ITEM_ROUTE_113_TM_32                     (FLAG_HIDDEN_ITEMS_START + 0x86)//Doesn't regen
...
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_2F_NORMAL_GEM_1        (FLAG_HIDDEN_ITEMS_START + 0x71)
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_2F_NORMAL_GEM_2        (FLAG_HIDDEN_ITEMS_START + 0x72)
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_2F_NORMAL_GEM_3        (FLAG_HIDDEN_ITEMS_START + 0x73)
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_2F_NORMAL_GEM_4        (FLAG_HIDDEN_ITEMS_START + 0x74)
#define FLAG_HIDDEN_ITEM_ROUTE_111_NORMAL_GEM_1              (FLAG_HIDDEN_ITEMS_START + 0x75)
#define FLAG_HIDDEN_ITEM_ROUTE_111_NORMAL_GEM_2              (FLAG_HIDDEN_ITEMS_START + 0x76)
#define FLAG_HIDDEN_ITEM_ROUTE_111_NORMAL_GEM_3              (FLAG_HIDDEN_ITEMS_START + 0x77)
#define FLAG_HIDDEN_ITEM_ROUTE_111_NORMAL_GEM_4              (FLAG_HIDDEN_ITEMS_START + 0x78)
#define FLAG_HIDDEN_ITEM_ROUTE_114_NORMAL_GEM_1              (FLAG_HIDDEN_ITEMS_START + 0x79)
#define FLAG_HIDDEN_ITEM_ROUTE_114_NORMAL_GEM_2              (FLAG_HIDDEN_ITEMS_START + 0x7A)
#define FLAG_HIDDEN_ITEM_ROUTE_114_NORMAL_GEM_3              (FLAG_HIDDEN_ITEMS_START + 0x7B)
#define FLAG_HIDDEN_ITEM_ROUTE_114_NORMAL_GEM_4              (FLAG_HIDDEN_ITEMS_START + 0x7C)
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_NORMAL_GEM_1           (FLAG_HIDDEN_ITEMS_START + 0x7D)
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_NORMAL_GEM_2           (FLAG_HIDDEN_ITEMS_START + 0x7E)
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_NORMAL_GEM_3           (FLAG_HIDDEN_ITEMS_START + 0x7F)
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_NORMAL_GEM_4           (FLAG_HIDDEN_ITEMS_START + 0x80)
#define HIDDEN_ITEM_FLAGS_END FLAG_HIDDEN_ITEM_VICTORY_ROAD_NORMAL_GEM_4 //Exclude the items we don't want to regenerate
