...
#define FLAG_HIDE_BRUCE_1    0x20 // Unused Flag
#define FLAG_HIDE_BRUCE_2    0x21 // Unused Flag
#define FLAG_HIDE_LONG       0x22 // Unused Flag
#define FLAG_RECEIVED_PRIMEAPE 0x23 // Unused Flag
