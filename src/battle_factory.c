...
static void SetRentalsToOpponentParty(void)
{
    ...
    for (i = 0; i < 3; i++)
    {
        ...
        gSaveBlock2Ptr->frontier.rentalMons[i + 3].abilityBit = GetBoxMonData(&gEnemyParty[i].box, MON_DATA_ABILITY_SLOT, NULL);
...
static void SetPlayerAndOpponentParties(void)
{
    ...
    if (gSpecialVar_0x8005 < 2)
    {
        ...
        for (i = 0; i < 3; i++)
        {
            ...
            SetMonData(&gPlayerParty[i], MON_DATA_ABILITY_SLOT, &gSaveBlock2Ptr->frontier.rentalMons[i].abilityBit);
        }
    }
    ...
    case 2:
        for (i = 0; i < 3; i++)
        {
            ...
            SetMonData(&gEnemyParty[i], MON_DATA_ABILITY_SLOT, &gSaveBlock2Ptr->frontier.rentalMons[i + 3].abilityBit);
        }
        break;
    }
}
