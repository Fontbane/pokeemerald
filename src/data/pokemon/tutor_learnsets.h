...
{
    [TUTOR_MOVE_HEAL_BELL] = MOVE_MEGA_PUNCH,
    [TUTOR_MOVE_IRON_TAIL] = MOVE_SWORDS_DANCE,
    [TUTOR_MOVE_AQUA_TAIL] = MOVE_MEGA_KICK,
    ...
    [TUTOR_MOVE_EMBARGO] = MOVE_SOFT_BOILED,
    [TUTOR_MOVE_DREAM_EATER] = MOVE_DREAM_EATER,
    [TUTOR_MOVE_DRILL_RUN] = MOVE_THUNDER_WAVE,
    [TUTOR_MOVE_SIGNAL_BEAM] = MOVE_EXPLOSION,
    [TUTOR_MOVE_BOUNCE] = MOVE_ROCK_SLIDE,
    [TUTOR_MOVE_IRON_HEAD] = MOVE_SUBSTITUTE,
    [TUTOR_MOVE_DYNAMIC_PUNCH] = MOVE_DYNAMIC_PUNCH,
    [TUTOR_MOVE_ROLLOUT] = MOVE_ROLLOUT,
    [TUTOR_MOVE_SEED_BOMB] = MOVE_PSYCH_UP,
    [TUTOR_MOVE_SNORE] = MOVE_SNORE,
    [TUTOR_MOVE_ICY_WIND] = MOVE_ICY_WIND,
    [TUTOR_MOVE_ENDURE] = MOVE_ENDURE,
    [TUTOR_MOVE_GUNK_SHOT] = MOVE_MUD_SLAP,
    [TUTOR_MOVE_ICE_PUNCH] = MOVE_ICE_PUNCH,
    [TUTOR_MOVE_IRON_DEFENSE] = MOVE_SWAGGER,
    [TUTOR_MOVE_MAGIC_COAT] = MOVE_SLEEP_TALK,
    [TUTOR_MOVE_SWIFT] = MOVE_SWIFT,
    [TUTOR_MOVE_HYPER_VOICE] = MOVE_DEFENSE_CURL,
