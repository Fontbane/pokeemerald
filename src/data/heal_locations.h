static const struct HealLocation sHealLocations[] =
{
    ...
    {MAP_GROUP(TALIA_TOWN), MAP_NUM(TALIA_TOWN), 3, 15},
    {MAP_GROUP(ROUTE1), MAP_NUM(ROUTE1), 15, 14},
    {MAP_GROUP(SMOL_TOWN), MAP_NUM(SMOL_TOWN), 0, 0},
    {MAP_GROUP(NEW_MAP1), MAP_NUM(NEW_MAP1), 16, 26},
};
