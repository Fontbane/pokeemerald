...
static const struct TrainerMonNoItemCustomMoves sParty_Braxton[] = {
    ...
    .lvl = 33,
    .species = SPECIES_SWELLOW,
    .moves = {MOVE_ACROBATICS, MOVE_QUICK_ATTACK, MOVE_FLAIL, MOVE_ENDEAVOR}
    },
    {
    .iv = 100,
    .lvl = 33,
...
static const struct TrainerMonNoItemCustomMoves sParty_Wendy[] = {
    ...
    .lvl = 34,
    .species = SPECIES_MAWILE,
    .moves = {MOVE_BATON_PASS, MOVE_SWORDS_DANCE, MOVE_SUBSTITUTE, MOVE_BITE}
    },
    {
    .iv = 100,
    .lvl = 34,
    .species = SPECIES_LURANTIS,
    .moves = {MOVE_LEAF_BLADE, MOVE_SYNTHESIS, MOVE_X_SCISSOR, MOVE_NIGHT_SLASH}
    },
    {
    .iv = 100,
    .lvl = 34,
...
static const struct TrainerMonItemCustomMoves sParty_Daphne[] = {
    ...
    .species = SPECIES_LUVDISC,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_ATTRACT, MOVE_SAFEGUARD, MOVE_SCALD, MOVE_WATER_PULSE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Olivia[] = {
    ...
    .moves = {MOVE_IRON_DEFENSE, MOVE_CLAMP, MOVE_RAIN_DANCE, MOVE_WATER_PULSE}
    },
    {
    .iv = 100,
    .lvl = 43,
    .species = SPECIES_CRAWDAUNT,
    .moves = {MOVE_TAUNT, MOVE_CRABHAMMER, MOVE_SUCKER_PUNCH, MOVE_NONE}
    },
    {
    .iv = 100,
    .lvl = 44,
...
static const struct TrainerMonNoItemCustomMoves sParty_Drew[] = {
    ...
    .lvl = 27,
    .species = SPECIES_DARUMAKA,
    .moves = {MOVE_ROLLOUT, MOVE_FIRE_PUNCH, MOVE_INCINERATE, MOVE_BITE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Beau[] = {
    ...
    .moves = {MOVE_BITE, MOVE_SAND_ATTACK, MOVE_SAND_TOMB, MOVE_DIG}
    },
    {
    .iv = 0,
    .lvl = 27,
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .moves = {MOVE_POISON_JAB, MOVE_HI_JUMP_KICK, MOVE_FOUL_PLAY, MOVE_SWAGGER}
    },
    {
    .iv = 250,
    .lvl = 51,
    ...
    .moves = {MOVE_WATERFALL, MOVE_FAKE_OUT, MOVE_NIGHT_SLASH, MOVE_ICE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_CONFUSE_RAY, MOVE_PSYSHOCK, MOVE_MYSTICAL_FIRE}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .moves = {MOVE_HEX, MOVE_FLAMETHROWER, MOVE_WILL_O_WISP, MOVE_ENERGY_BALL}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .moves = {MOVE_SUBSTITUTE, MOVE_FAKE_OUT, MOVE_SWAGGER, MOVE_FOUL_PLAY}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .moves = {MOVE_SHADOW_SNEAK, MOVE_DAZZLING_GLEAM, MOVE_SUCKER_PUNCH, MOVE_DESTINY_BOND}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_SHADOW_CLAW, MOVE_ICE_PUNCH, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .moves = {MOVE_AURORA_VEIL, MOVE_BLIZZARD, MOVE_MOONBLAST, MOVE_WATER_PULSE}
    },
    {
    .iv = 250,
    .lvl = 55,
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_EXTRASENSORY, MOVE_ENERGY_BALL, MOVE_ICE_BEAM}
    },
    {
    .iv = 250,
    .lvl = 55,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_SUPERPOWER, MOVE_ICICLE_CRASH, MOVE_EARTHQUAKE, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = 250,
    .lvl = 55,
    ...
    .moves = {MOVE_CRUNCH, MOVE_ROCK_SLIDE, MOVE_BODY_SLAM, MOVE_ICE_FANG}
    },
    {
    .iv = 255,
    .lvl = 57,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .moves = {MOVE_SMOKESCREEN, MOVE_DRAGON_PULSE, MOVE_SURF, MOVE_ICE_BEAM}
    },
    {
    .iv = 250,
    .lvl = 57,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLY, MOVE_DRAGON_CLAW, MOVE_ROCK_SLIDE, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STEALTH_ROCK, MOVE_LEECH, MOVE_ROCK_THROW, MOVE_ROCK_TOMB}
    },
    {
    .iv = 100,
    .lvl = 12,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ASTONISH, MOVE_ABSORB, MOVE_ACID, MOVE_ROCK_TOMB}
    },
    {
    .iv = 200,
    .lvl = 15,
    ...
    .moves = {MOVE_BLOCK, MOVE_HARDEN, MOVE_PECK, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .species = SPECIES_MACHOP,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_KNOCK_OFF, MOVE_LOW_KICK, MOVE_ROCK_TOMB, MOVE_BULK_UP}
    },
    {
    .iv = 100,
    .lvl = 16,
    ...
    .species = SPECIES_MAKUHITA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FORCE_PALM, MOVE_KNOCK_OFF, MOVE_REVERSAL, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .moves = {MOVE_LIGHT_SCREEN, MOVE_VOLT_SWITCH, MOVE_SELF_DESTRUCT, MOVE_ELECTRO_BALL}
    },
    {
    .iv = 200,
    .lvl = 24,
    .species = SPECIES_JOLTIK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ELECTROWEB, MOVE_STRUGGLE_BUG, MOVE_STICKY_WEB, MOVE_VOLT_SWITCH}
    },
    {
    .iv = 220,
    .lvl = 24,
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ELECTRIC_TERRAIN, MOVE_VOLT_SWITCH, MOVE_THUNDER_WAVE, MOVE_MIRROR_SHOT}
    },
    {
    .iv = 250,
    .lvl = 26,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .species = SPECIES_SLUGMA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_CLEAR_SMOG, MOVE_LIGHT_SCREEN, MOVE_SOLAR_BEAM}
    },
    {
    .iv = 250,
    .lvl = 27,
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_BULLDOZE, MOVE_ROCK_TOMB, MOVE_ATTRACT}
    },
    {
    .iv = 250,
    .lvl = 29,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .moves = {MOVE_SURF, MOVE_BELLY_DRUM, MOVE_FACADE, MOVE_PLAY_ROUGH}
    },
    {
    .iv = 250,
    .lvl = 32,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ICE_PUNCH, MOVE_YAWN, MOVE_FACADE, MOVE_FAINT_ATTACK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .moves = {MOVE_BOOMBURST, MOVE_ROOST, MOVE_HEAT_WAVE, MOVE_ACROBATICS}
    },
    {
    .iv = 210,
    .lvl = 34,
    .species = SPECIES_TROPIUS,
    .heldItem = ITEM_YACHE_BERRY,
    .moves = {MOVE_ROOST, MOVE_AERIAL_ACE, MOVE_ENERGY_BALL, MOVE_SUNNY_DAY}
    },
    {
    .iv = 210,
    .lvl = 34,
    ...
    .moves = {MOVE_WATER_PULSE, MOVE_ROOST, MOVE_RAIN_DANCE, MOVE_HURRICANE}
    },
    {
    .iv = 220,
    .lvl = 34,
    ...
    .moves = {MOVE_SAND_ATTACK, MOVE_ROOST, MOVE_STEEL_WING, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 36,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_PSYCHIC, MOVE_HYPNOSIS, MOVE_CALM_MIND}
    },
    {
    .iv = 250,
    .lvl = 46,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .moves = {MOVE_BODY_SLAM, MOVE_ICE_BALL, MOVE_RAIN_DANCE, MOVE_SURF}
    },
    {
    .iv = 200,
    .lvl = 49,
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_POISON_JAB, MOVE_CRABHAMMER, MOVE_X_SCISSOR, MOVE_NIGHT_SLASH}
    },
    {
    .iv = 250,
    .lvl = 50,
...
static const struct TrainerMonNoItemCustomMoves sParty_Quincy[] = {
    ...
    .lvl = 47,
    .species = SPECIES_SLAKING,
    .moves = {MOVE_ATTRACT, MOVE_ICE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_FIRE_PUNCH}
    },
    {
    .iv = 100,
    .lvl = 47,
...
static const struct TrainerMonNoItemCustomMoves sParty_Katelynn[] = {
    ...
    .lvl = 47,
    .species = SPECIES_GARDEVOIR,
    .moves = {MOVE_SKILL_SWAP, MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_MOONBLAST}
    },
    {
    .iv = 100,
    .lvl = 47,
    .species = SPECIES_SLAKING,
    .moves = {MOVE_EARTHQUAKE, MOVE_SHADOW_PUNCH, MOVE_AERIAL_ACE, MOVE_BRICK_BREAK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .moves = {MOVE_EXPLOSION, MOVE_WATER_SPOUT, MOVE_DOUBLE_EDGE, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 59,
    ...
    .species = SPECIES_AZUMARILL,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_AQUA_JET, MOVE_WATERFALL, MOVE_PLAY_ROUGH, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 60,
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .lvl = 50,
    .species = SPECIES_ALTARIA,
    .moves = {MOVE_AERIAL_ACE, MOVE_SAFEGUARD, MOVE_DRAGON_PULSE, MOVE_ROOST}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .lvl = 50,
    .species = SPECIES_MAGNEZONE,
    .moves = {MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT, MOVE_TRI_ATTACK, MOVE_FLASH_CANNON}
    },
    {
    .iv = 250,
    .lvl = 52,
...
static const struct TrainerMonNoItemCustomMoves sParty_KimAndIris[] = {
    ...
    .lvl = 41,
    .species = SPECIES_CAMERUPT,
    .moves = {MOVE_ROCK_SLIDE, MOVE_FLAMETHROWER, MOVE_REST, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_TyraAndIvy[] = {
    ...
    .lvl = 22,
    .species = SPECIES_GRAVELER,
    .moves = {MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_BULLDOZE, MOVE_ROCK_THROW}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Leonel[] = {
    ...
    .lvl = 33,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_THUNDER, MOVE_QUICK_ATTACK, MOVE_ICE_FANG, MOVE_FIRE_FANG}
    }
};
