...
static bool8 ExtractMonDataToSummaryStruct(struct Pokemon *mon)
{
    ...
    case 0:
        ...
        sum->abilitySlot = GetMonData(mon, MON_DATA_ABILITY_SLOT);
...
static void PrintMonAbilityName(void)
{
    u8 ability = GetAbilityBySpecies(sMonSummaryScreen->summary.species, sMonSummaryScreen->summary.abilitySlot);
